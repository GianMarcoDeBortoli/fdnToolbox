% Example for time-varying circulant matrix
%
% Process a musical sound with a time-varying CFDN reverberation.
% Different options include slow and fast time-variation.
%
